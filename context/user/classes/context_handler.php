...
class context_handler extends \local_metadata\context\context_handler {
    ...
    public function require_access() {
        ...
        require_login();
        // UNISTRA DEV.
        require_capability('local/metadata:edituser', $this->context);
        // End UNISTRA DEV.
    ...
    public function add_settings_to_context_menu($navmenu) {
        ...
        $navmenu->add('users', new \admin_externalpage('metadatacontext_users', get_string('metadatatitle', 'metadatacontext_user'),
                new \moodle_url('/local/metadata/index.php', ['contextlevel' => CONTEXT_USER]), ['moodle/site:config'/*UNISTRA DEV*/,'local/metadata:edituser'/*End UNISTRA DEV*/]));
        return true;
    }
