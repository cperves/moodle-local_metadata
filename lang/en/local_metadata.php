...
// UNISTRA DEV.
$string['coursemodulehookenabled']= 'Course module edition page hook enabled.';
$string['coursemodulehookenabled_desc']= 'By enablin this, metadatas would be changed into the course module edition page.';
$string['metadata:view']= 'Can view metadatas.';
$string['metadata:edituser']='Can edit metadatas in user context.';
$string['metadata:editcategory']='Can edit metadatas in category context.';
$string['metadata:editcourse']='Can edit metadatas in course context.';
$string['metadata:editmodule']='Can edit metadatas in module context.';
$string['metadata:editcohort']='Can edit metadatas in cohort context.';
$string['metadata:editgroup']='Can edit metadatas in group context.';
// End UNISTRA DEV.
