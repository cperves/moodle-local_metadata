...
if ($hassiteconfig) {
    ...
    // UNISTRA DEV.
    // add a settings to choose to have course module edit page or not
    $item = new admin_setting_configcheckbox('local_metadata/coursemodulehookenabled',get_string('coursemodulehookenabled', 'local_metadata'),get_string('coursemodulehookenabled_desc', 'local_metadata'),1);
    $settings->add($item);
    // End UNISTRA DEV.
